    ...
    <section id="contact" className="relative py-32">
      ...
      <div className="container-cinematic section-padding relative z-10">
        <motion.div
          ...
          className="mb-4"
        >
          <span className="text-xs tracking-[0.2em] uppercase text-purple-400">Contact</span>
        </motion.div>
        ...
        <div className="flex flex-col items-center gap-6 mb-16">
          <ScrollReveal>
            <a
              ...
              className="flex items-center gap-3 px-6 py-3 rounded-full bg-white/5 border border-white/10 text-zinc-300 hover:text-white hover:bg-white/10 hover:border-purple-500/40 transition-all duration-300"
            >
        ...
        <div className="max-w-2xl mx-auto">
          <ScrollReveal>
            <img
              src="https://ghchart.rshah.org/643cf0/valenzuelajp"
