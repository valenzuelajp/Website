      ...
      <div className="container-cinematic section-padding relative z-10">
        ...
        >
          <span className="inline-flex items-center gap-2 text-xs tracking-[0.2em] uppercase text-amber-400">
            <span className="text-base" role="img" aria-label="mail">✉️</span> Contact
          </span>
        </motion.div>
        ...
        <div className="flex flex-col items-center gap-6 mb-16">
          <ScrollReveal>
            <a
              ...
              className="flex items-center gap-3 px-6 py-3 rounded-full bg-amber-500/10 border border-amber-500/20 text-amber-300 hover:text-amber-200 hover:bg-amber-500/20 hover:border-amber-500/40 transition-all duration-300"
            >
          ...
          <ScrollReveal>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-3 px-6 py-3 rounded-full bg-white/5 border border-white/10 text-zinc-300 hover:text-white hover:bg-white/10 hover:border-amber-500/40 transition-all duration-300"
            >
