...
const HUDParticles = dynamic(() => import("@/components/three/HUDParticles"), { ssr: false });
    ...
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container-cinematic section-padding flex flex-col items-center text-center relative z-10">
        ...
        <motion.h1
          ...
          className="relative text-5xl md:text-7xl lg:text-8xl font-bold tracking-[0.02em] text-white mb-6 font-display leading-[0.9] uppercase"
        >
          <span className="relative block text-white">Jhon Paul</span>
          <span className="relative block mt-2 text-[0.82em] tracking-[0.14em] text-amber-500">Valenzuela</span>
        </motion.h1>
        ...
        <motion.p
          ...
          className="max-w-2xl mb-8 leading-relaxed text-base md:text-lg text-zinc-400 font-sans"
        >
          I craft digital products and interactive platforms at the intersection of full-stack engineering and creative hardware design.
        </motion.p>
